...
if (mySpeed > speedLimit) {
    ...
    } else { /*doesn't have a conditional if it is the default*/
        console.log("Speed up! Dad is mad!");
    } /*Note regarding equal signs: = is an 
assignment operator; == is for checking 
to see if the values are the same; === is
checking to see if the value and the
datatype are the same*/  
